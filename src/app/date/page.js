...
const events = [
  { 
    ...
    activity: "I shall meet you at Blumentritt station so that we can transport on a Mabini jeep together xd.", 
  ...
  { 
    ...
    activity: "We shall enjoy the wonders of science and technology together in BGC.", 
  ...
  { 
    ...
    activity: "We'lltravel back and head home with our hearts full and happy hehe xd.", 
    ...
    <main className="min-h-screen w-full bg-transparent pt-6 pb-0 sm:pt-12 sm:pb-0 flex flex-col justify-between font-serif">
      ...
      <div className="py-3 sm:max-w-5xl sm:mx-auto w-full px-2 sm:px-0">
        ...
        <div className="relative text-gray-700 antialiased text-sm font-semibold">
          ...
          <div className="hidden sm:block w-1 bg-pink-300/60 absolute h-full left-1/2 transform -translate-x-1/2"></div>
              ...
              <div className="flex flex-col sm:flex-row items-center">
                ...
                <div className={`flex w-full mx-auto items-center ${index % 2 === 0 ? "justify-start" : "justify-end"}`}>
                  <div className={`w-full sm:w-1/2 ${index % 2 === 0 ? "sm:pr-8" : "sm:pl-8"}`}>
                    ...
                    <div className="p-6 w bg-white/80 rounded-xl shadow-lg hover:scale-110 transition-transform duration-300 border-t-4 border-pink-400 relative">
                      <h3 className="text-pink-400 font-bold text-lg mb-1">{event.time}</h3>
